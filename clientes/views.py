...
def generar_pdf_cliente(request):        
    ...
    #abrir pdf  = inline         Descargar =  attachent pdf
    ...
    def agregar_pie_pagina(pdf, pagina_num):
        ...
        pdf.drawString(30,20, f"fecha_generacion: {fecha_generacion}")
    ...
    imagen_ruta = "clientes/static/imagenes/imagen01.jpeg" 

    pdf.drawImage(imagen_ruta, 400, height - 60, width=50, height=50) 
    ...
    for i, encabezados  in enumerate(encabezados):
        pdf.drawString(x_inicial + i * 150, y, encabezados)
